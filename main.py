...
# 2) Δεν υλοποιήθηκε το σκέλος οπτικοποίησης των δεδομένων.
# 3) Το debugging της εφαρμογής υλοποιήθηκε με τα simulated uplinks/downlinks που παρέχει το TTN
# 4) Χρησιμοποιήθηκε ο λογαριασμός του Κυριακίδη Δημοσθένη στο TTN
# 5) Υλοποιήθηκε σε Python 3.10.4
